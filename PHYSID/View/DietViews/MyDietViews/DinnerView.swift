...
protocol DinnerViewDelegate: class {
...
class DinnerView: UIView {
    ...
    var user: User?
    var foods = [Food]()
    weak var delegate: DinnerViewDelegate?
    private let headerView = DinnerHeaderView()
...
extension DinnerView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate?.presentFoodThroughDinnerView(nav)
    }
